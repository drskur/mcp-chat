...
import type { Message, StreamData, FileAttachment, ToolUseContentItem } from '../types/chat.types';
...
export const useStreamingService = ({ modelId, setMessages }: UseStreamingServiceProps) => {
