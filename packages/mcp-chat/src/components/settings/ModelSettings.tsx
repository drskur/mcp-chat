    ...
    <div class="space-y-6">
      <div>
        ...
        <p class="text-sm text-muted-foreground mb-6">
          AI 모델의 동작을 구성합니다. 이 설정은 대화의 품질과 특성에 영향을
          줍니다.
        </p>
        ...
        <div class="space-y-4">
          <div class="rounded-lg p-4">
            ...
            <p class="text-xs text-muted-foreground mt-2">
              사용할 AI 모델을 선택합니다. 모델에 따라 응답 품질과 속도가
              달라집니다.
            </p>
          </div>
          ...
          <div class="rounded-lg p-4">
            ...
            <p class="text-xs text-muted-foreground mt-2">
              낮은 값은 더 일관되고 예측 가능한 응답을, 높은 값은 더 다양하고
              창의적인 응답을 생성합니다.
            </p>
          </div>
          ...
          <div class="rounded-lg p-4">
            ...
            <p class="text-xs text-muted-foreground mt-2">
              AI가 생성할 수 있는 최대 응답 길이입니다. 더 긴 응답이 필요한 경우
              이 값을 늘리세요.
            </p>
          </div>
          ...
          <div class="rounded-lg p-4">
            <TextFieldRoot>
              <TextFieldLabel class="text-sm font-medium block mb-2">
                시스템 프롬프트
              </TextFieldLabel>
              <TextArea
